...
describe('Authentication and Authorization tests (e2e)', () => {
    ...
    it('testing admin access with regular user', async () => {
        await request(testSetup.app.getHttpServer())
            .post('/auth/register')
            .send(testUser);
    ...
    it('attempting to register as an admin', async () => {
        const userAdmin = {
            ...testUser,
            roles: [Role.ADMIN],
        };
